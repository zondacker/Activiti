package com.changwen.activiti.f_sequenceFlow;
...
//	部署名称：连线
	...
	public void startProcessInstance(){
		...
		ProcessInstance pi = processEngine.getRuntimeService()//与正在执行的流程实例和执行对象相关的Service
						.startProcessInstanceByKey(processDefinitionKey);//使用流程定义的key启动流程实例，key对应helloworld.bpmn文件中id的属性值，使用key值启动，优点：是按照最新版本的流程定义启动
